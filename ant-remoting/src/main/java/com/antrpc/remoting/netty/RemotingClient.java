...
public interface RemotingClient extends BaseRemotingService{
     ...
     */
    RemotingTransporter invokeSync(final String addr , final RemotingTransporter request , final long timeoutMillis) throws InterruptedException , RemotingException ;
