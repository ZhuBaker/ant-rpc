package com.antrpc.client.provider.model;
...
public class ServiceWrapper {
    ...
    /****连接数，默认是1个****/
    private volatile int connCount =  Constants.DEFAULT_CONNECTION_COUNT;
    /*****是否进行限流 ****/
    private boolean isFlowController;
    /****单位时间内最大的调用次数****/
    private long maxCallCountInMinute =  Constants.DEFAULT_MAX_CALLCOUN_TINMINUTE;
